class StatisticsController < UITableViewController
  ...
  def tableView(tv, cellForRowAtIndexPath:indexPath)
    ...
    if (0 == indexPath.row)
      ...
      titleLabel = UILabel.alloc.initWithFrame([[15,5],[200,30]])
      ...
      countLabel = UILabel.alloc.initWithFrame([[295, 5],[40,30]])
      ...
      countLabel.frame = [[305-countLabel.frame.size.width, 5],[countLabel.frame.size.width, 30]]
